...
<!-- Tech name data for JS -->
<script>document.body.dataset.techName = "<?= htmlspecialchars($techName ?? 'Usuario') ?>";</script>
<!-- Modular Ticket Notes Script -->
<script src="<?= BASE_URL ?>js/ticket-notes.js?v=<?= time() ?>"></script>
