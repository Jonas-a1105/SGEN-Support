...
<div style="background: #f8fafc; min-height: 100vh; display: flex; align-items: flex-start; justify-content: center; padding: 2rem;">
    
    <div style="max-width: 1000px; width: 100%; background: white; border-radius: 1.5rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.15); overflow: hidden; display: flex; flex-wrap: wrap;">
        ...
        <div style="flex: 1; min-width: 400px; padding: 2.5rem 3rem; background: white;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <h1 style="font-size: 1.5rem; font-weight: 700; color: #0f172a; margin: 0;"><?= $es_edicion ? 'Editar' : 'Nuevo' ?> Empleado</h1>
                <a href="<?= BASE_URL ?>empleados" style="color: #94a3b8; text-decoration: none;">
