// Inicialización compatible con Turbo Drive
document.addEventListener('turbo:load', function () {
    ...
    const dataTableOptions = {
        ...
        "responsive": true,
        "autoWidth": false,
        "destroy": true // Permite reinicializar si Turbo restaura el DOM
    };
    ...
    tableIds.forEach(function (selector) {
        ...
        if ($el.length) {
            ...
            // Verificamos si ya está inicializada para evitar error de alert warning
            if ($el.prop('tagName') === 'TABLE') {
